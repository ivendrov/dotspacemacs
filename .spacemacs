...
before packages are loaded."
  ...
  ;; Convert list markers "-" into bullets.
  (font-lock-add-keywords 'org-mode
                          '(("^ *\\([-]\\) "
                             (0 (prog1 () (compose-region (match-beginning 1) (match-end 1) "•"))))))
  ;; Replace headline markers with different bullets.
  (use-package org-bullets
    :config
    (add-hook 'org-mode-hook (lambda () (org-bullets-mode 1))))
  ;; Use a proportional font.
  (let* ((variable-tuple
          (cond ((x-list-fonts "-*-Optima-normal-normal-normal-*-14-*-*-*-p-0-iso10646-1") '(:font "-*-Optima-normal-normal-normal-*-14-*-*-*-p-0-iso10646-1")) ;; favorite font on macbook.
